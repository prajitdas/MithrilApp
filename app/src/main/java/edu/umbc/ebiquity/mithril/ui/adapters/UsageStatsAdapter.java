...
import edu.umbc.ebiquity.mithril.ui.activities.UsageStatsActivity;
...
public class UsageStatsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UsageStatsActivity.AppViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new UsageStatsActivity.AppViewHolder();
            ...
            // and the ImageView.
            holder = (UsageStatsActivity.AppViewHolder) convertView.getTag();
        }
