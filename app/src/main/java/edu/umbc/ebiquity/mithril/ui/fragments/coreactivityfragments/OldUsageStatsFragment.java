 ...
 * interface.
 */
public class OldUsageStatsFragment extends Fragment {
     ...
     */
    public OldUsageStatsFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static OldUsageStatsFragment newInstance(int columnCount) {
        OldUsageStatsFragment fragment = new OldUsageStatsFragment();
