 ...
 * interface.
 */
public class SemanticActivityFragment extends Fragment {
     ...
     */
    public SemanticActivityFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static SemanticActivityFragment newInstance(int columnCount) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_semantic_activity_list, container, false);
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new SemanticActivityRecyclerViewAdapter(semanticActivities, mListener));
        }
        return view;
    }
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(SemanticActivity item);
    }
}