 ...
 * interface.
 */
public class ShowSystemAppsFragment extends Fragment {
     ...
     */
    public ShowSystemAppsFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static ShowSystemAppsFragment newInstance(int columnCount) {
        ShowSystemAppsFragment fragment = new ShowSystemAppsFragment();
