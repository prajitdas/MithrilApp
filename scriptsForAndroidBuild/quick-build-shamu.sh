...
if [[ $model == $expected ]]; then
        ...
        ./extract-files.sh
	cp ~/android/proprietary_vendor_stuff/proprietary_vendor_motorola/shamu/proprietary/app/Tycho/Tycho.apk vendor/motorola/shamu/proprietary/app/Tycho/Tycho.apk
	cp ~/android/proprietary_vendor_stuff/proprietary_vendor_motorola/shamu/proprietary/priv-app/GCS/GCS.apk vendor/motorola/shamu/proprietary/priv-app/FCS/GCS.apk
        export USE_CCACHE=1
        croot
